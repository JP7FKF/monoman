class SoftwaresController < ApplicationController
  ...
  private
    ...
    def software_params
      params.require(:software).permit(:asset_category, :asset_code, :category, :manufacturer, :product_name, :serial_code, :localtion, :administrator, :user, :expiration_date, :acquisition_date, :acquisition_price, :amortization_period, :amortize_state, :remarks)
    end
end
