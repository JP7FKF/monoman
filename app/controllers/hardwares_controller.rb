class HardwaresController < ApplicationController
  ...
  private
    ...
    def hardware_params
      params.require(:hardware).permit(:asset_category, :asset_code, :category, :manufacturer, :model, :serial_code, :localtion, :administrator, :user, :acquisition_date, :acquisition_price, :amortization_period, :amortize_state, :remarks)
    end
end
